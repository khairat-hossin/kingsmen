    ...
    <div class="container" data-aos="fade-up">
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-12 col-sm-12 col-xl-8 col-lg-8 mt-5">
                  <h1 class="text-white text-center fw-lighter text-uppercase lh-base mt-2 fw-light">{{ $latestBannerText }}<span>!</span></h1>
              </div>
          </div>
      </div>
</section>
...
<style>
    #hero_about {
        background: url("{{ asset($latestBanner    ) }}") top center;
    }
</style>
