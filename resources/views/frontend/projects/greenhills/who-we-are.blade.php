    ...
    <section class="py-0">
      <div class="container">
        <div class="row row-cols-1 row-cols-lg-2 row-cols-md-2 d-flex align-items-center justify-content-center">
          ...
          <a href="https://www.kmen.me/" class="btn btn-outline-warning w-50 mt-4">Check offers</a>
        </div>
      </div>
    </section>
        ...
        <div class="container" data-aos="zoom-in">
          ...
          <div class="clients-slider swiper">
            <div class="swiper-wrapper align-items-center ">
              <div class="swiper-slide"><img src="../../assets/img/greenhills/clients/client-1.png" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="../../assets/img/greenhills/clients/client-2.png" class="img-fluid" alt=""></div>
              <div class="swiper-slide"><img src="../../assets/img/greenhills/clients/client-3.png" class="img-fluid" alt=""></div>
            </div>
