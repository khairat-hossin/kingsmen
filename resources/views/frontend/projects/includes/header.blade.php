 ...
 <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="{{ route('frontend.eco_home') }}" class="logo me-auto me-lg-0"><img src="../../assets/img/ecogardens/portfolio/Green Hills.jpg"  loading="lazy" alt="logo" class="img-fluid"></a>
