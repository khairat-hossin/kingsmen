                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="clients-slider swiper">
                        <div class="swiper-wrapper align-items-center">
                            <div class="swiper-slide text-center"><img src="assets/img/clients/client-9.png"
                                    class="img-fluid" alt="">
                            </div>
                            <div class="swiper-slide text-center"><img src="assets/img/clients/client-10.png"
                                    class="img-fluid" alt=""></div>
                            <div class="swiper-slide text-center"><img src="assets/img/clients/client-11.jpg"
                                    class="img-fluid" alt=""></div>
                        </div>
                        <div class="swiper-pagination"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 ">
                            <div>
                                ...
                                <div class="swiper-slide text-center w-40"><img src="assets/img/clients/onlinebanking.png"
                                        class="w-50" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="clients-slider swiper">
                        ...
                        <div class="swiper-wrapper align-items-center">
                            <div class="swiper-slide text-center"><img src="assets/img/clients/architech.png"
                                    class="img-fluid" alt=""></div>
                            <div class="swiper-slide text-center"><img src="assets/img/clients/constractions.png"
                                    class="img-fluid" alt=""></div>
                        </div>
                        <div class="swiper-pagination"></div>
                    </div>
            ...
            <section id="cta" class="cta p-3">
                <div class="container" data-aos="fade-up">
                    <div class="text-center">
                        <h3>"Invest in Your Homeland ". from Anywhere in the World with Kingsmen Armenia</h3>
