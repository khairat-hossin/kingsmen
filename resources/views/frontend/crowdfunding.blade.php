  ...
  <section id="one-tree-armenia" class="">
    <div class="container bg-dark text-white card raw_card">
      <div class="row row-cols-1 row-cols-lg-2 row-cols-md-2  d-flex justify-content-center align-items-center">
          ...
          <div class=" ">
            <p class="my-3" style="  font-family: 'Inter', sans-serif; "> <strong> The One Tree Armenia </strong> is an ambitious agriculture project located in Aragatsavan Village in the Aragatsotn Region of Armenia. With a total area of 475,000 square meters and 15,333 walnut trees planted on the site, this project is set to revolutionize the local agricultural industry.</p>
            <div class="my-2">
