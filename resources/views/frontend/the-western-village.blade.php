...
@section('content')
    <!-- ======= Hero Section ======= -->
    <section id="hero-the-western-village" class="d-flex align-items-center justify-content-center" style="padding: 3px ;">
        <div class="container-fluid" data-aos="fade-up">
          <div class="row row-cols-1 justify-content-center" data-aos="fade-up" data-aos-delay="150">
            <div class="row"></div>
            <div class="col-12 col-sm-10 col-md-9 col-xl-6">
              <h3 class="text-center text-white  my-4">	"Invest in the Future of Upscale Living Today!"<span>.</span></h3>
            </div>
          </div>
          <div class="row"></div>
        </div>
            ...
            <div class="row row-cols-1 d-flex justify-content-center align-items-center">
              ...
              <div class="gy-5" style=" font-family: 'Inter', sans-serif;text-align: justify; "class="gx-5" style="   font-family: 'Inter', sans-serif;text-align: justify; ">
               ...
               <p> <strong> Designed By Jamil Hannouche  ( We are in the Phase of Developing the project full identity  we Always target the armenian Diaspora for end-user homes , since they prefer to buy a finished product and usually the competition only sells core and shell with very low quality and higher prices. )
                ...
                <div>
                  <a href="https://docs.google.com/spreadsheets/d/1HJIHdnjD5_ZHRSO-PHTaVGULu3i64BTVvaYQxAADlgo/edit#gid=310063620" class="btn my-5"> View summarized cost </a>
                </div>
        </section>
                ...
                <section id="Return on Investment" class="">
                  <div class="container">
                    <div
                      ...
                      <div>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d24346.27477519841!2d44.334232!3d40.291645!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406a9aa1d0bc6a7b%3A0x21a63246231704f5!2sAshtarak%2C%20Armenia!5e0!3m2!1sen!2sus!4v1682962597941!5m2!1sen!2sus" width="100%" height="300px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                      </div>
                      <div class="" style="text-align: justify; font-family: 'inter',sans-serif;">
                        <strong>Calculate the Cost Based on the Number of Share you Are interested to Purchase  </strong>
                        <h6 class="">Each 1 Share Value is offered for : <span class="text-info">55,000 USD</span></h6>
                        <h6 class=" ">Each 1 Share Value Represents The Following :   <span class="text-info">4,500 sqm of Land </span></h6>
                        <h6 class=" ">Expecting Selling at:<span class="text-info">60$</span> by the End of:  <span class="text-info">2027</span>
                        </h6>
                        <h6 class=" ">Notes:<span class="text-info">The Price of 40$ represents the Value of  a Small Land today, Kingsmen Return on investment is calculated based on selling Worst Case Scenario calculation </span>
                        </h6>
                        <h6 class=" ">Capital Return Duration: <span class="text-info">3</span>Years Starting
                          Year:<span class="text-info">2024</span></h6>
                        <h6 class=" ">Starting Year <span class="text-info">2024 :  33.33 %</span>Per Year Annual Income
                        </h6>
                        <h6 class=" ">Share Value bought at :<span class="text-info">18$/Sqm</span>
                       </h6>
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLScxGVRR1YBwpRzNktQz6orHx34JHoNMlXp8OG3ZCWa_QN9tDA/formrestricted" class="btn mt-5">Feedback
                          </a>
                      </div>
                    </div>
                  </div>
                ...
                <section id="timeline summary text">
                  <div class="container" style="text-align: justify; font-family: 'Inter',sans-serif;">
                    <div class="row">
                      ...
                      <h6> <span class="text-warning">Land has been purchased and registered under Kingsmen Investments in May 2023</h6>

                      <h6> <span class="text-warning">Electricity was brought in during June 2023</h6>
                      <h6><span class="text-warning">Design for the development was finalized and approved in July 2023</h6>
                      <h6><span class="text-warning">All necessary permits have been obtained for infrastructure construction, work will commence shortly Construction includes roads, sidewalks, lighting, Fence and landscaping.</h6>
                      <h6><span class="text-warning"> Kingsmen is committed to completing infrastructure development to the highest standards and in a timely manner.</h6>
                        <a href="https://docs.google.com/forms/d/e/1FAIpQLScxGVRR1YBwpRzNktQz6orHx34JHoNMlXp8OG3ZCWa_QN9tDA/formrestricted" class="btn">Invest now
                        </a>
                    </div>
                  </div>
                </section>
            ...
            <div id="sign-up" class="container" data-aos="fade-up" >
              <div class="row gy-2 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
                <div class="col-12 col-sm-10 col-xl-10 col-md-10 col-lg-10">
                  <div class="icon-box bg-dark rounded-pill">
                    <h3 class="text-uppercase"><a href="">Here are five benefits of crowdfunding into The Western Village:</a>  </h3>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row mx-1">
              <ol class="fs-6">
                <li class="fw-semi-bold">
                  Accessible Investment Opportunity: Crowdfunding allows investors to participate in large development projects such as The Western Village at lower investment amounts, which makes investing in lucrative real estate markets more accessible.</li>
                <li class="fw-semi-bold">Potentially High Returns: Investors in The Western Village have an opportunity to earn high returns on their investment if the project is successful. The real estate market in Parpi Ashtarak Region is rapidly growing, and investing in the area at an early stage can be a smart financial move.</li>
                <li class="fw-semi-bold">Managed Risks: Kingsmen Investments has years of experience in real estate investments, and they are well-equipped to manage risks and identify profitable opportunities. This means that investors in The Western Village can rely on Kingsmen to develop the infrastructure and execute the project in a professional and competent manner.</li>
                ...
                <li class="fw-semi-bold">Transparency: Kingsmen Investments is committed to providing investors with regular and transparent reporting on The Western Village project. This level of communication and transparency allows investors to track their investments and stay updated on the project's progress.</li> <br>
                <h6 class="fw-bold">Diversification: Investing in The Western Village through crowdfunding also offers investors a chance to diversify their portfolio. Real estate is an excellent hedge against inflation, and investing in a promising development project, such as The Western Village, can result in strong, stable financial returns.</h5>
            </div>
          </div>
          </div>
        </section>
