...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mt-4">
            <div class="col">
                {{ html()->modelForm($module_name, 'PATCH', route("backend.$module_name.update", $module_name))->class('form')->attribute('enctype', 'multipart/form-data')->open() }}

                @include ("$module_path.about_us.edit_form")
