...
class GenerateMenus
{
    ...
    public function handle($request, Closure $next)
    {
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            // Crowdfundings
            $menu->add('<i class="nav-icon fas fa-donate"></i>Crowdfundings', [
                'route' => 'backend.crowdfundings.index',
                'class' => 'nav-item',
            ])
            ->data([
                'order' => 2,
                'activematches' => 'admin/crowdfundings*',
                'permission' => [],
            ])
            ->link->attr([
                'class' => 'nav-link',
            ...
            // Projects
            $menu->add('<i class="nav-icon fa-solid fa-tree-city"></i>Projects', [
            ...
            // Contacts
            $menu->add('<i class="nav-icon fa-solid fa-address-book"></i>Contacts', [
            ...
            // Brokers
            $menu->add('<i class="nav-icon fa-brands fa-stack-exchange"></i>Brokers', [
                'route' => 'backend.brokers.index',
                'class' => 'nav-item',
            ])
            ->data([
                'order' => 8,
                'activematches' => 'admin/brokers*',
                'permission' => [],
            ])
            ->link->attr([
                'class' => 'nav-link',
