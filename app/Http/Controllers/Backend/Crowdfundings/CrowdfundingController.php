...
class CrowdfundingController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validatedData = $request->validate([
            ...
            '1_shares_of_ownership_of_the_land_in_sqm' => 'nullable',
            '1_shares_of_ownership_of_the_construction_in_sqm' => 'nullable',
            '1_shares_of_ownership_in_number_of_investing_in' => 'nullable',
