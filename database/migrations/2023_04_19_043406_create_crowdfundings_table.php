...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('crowdfundings', function (Blueprint $table) {
            ...
            $table->double('total_built_up_area_value_per_sqm', 8, 2)->nullable();
            ...
            $table->double('expected_profit_%_after_break_even_as_per_study',8,2)->nullable();
            $table->double('real_estate_share_value_of_land_in_sqm',8,2)->nullable();
            $table->double('real_estate_share_value_of_construction_in_sqm', 8, 2)->nullable();
            $table->double('real_estate_share_value_in_number_of_investing_in',8,2)->nullable();
