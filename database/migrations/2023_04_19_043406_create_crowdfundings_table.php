...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('crowdfundings', function (Blueprint $table) {
            ...
            $table->date('project_startingDate')->nullable();
            $table->date('project_deliveryDate')->nullable();
            $table->double('project_duration_in_years', 8,2)->nullable();
            $table->string('land_category')->nullable();
            $table->double('landArea_per_sqm', 8, 2)->nullable();
            $table->double('landCost_per_sqm', 8, 2)->nullable();
            $table->double('total_landCost', 8, 2)->nullable();
            $table->string('available_construction_type')->nullable();
            $table->double('builtUpAreaSize_per_sqm', 8, 2)->nullable();
            $table->double('builtUpAreaValue_per_sqm', 8, 2)->nullable();
            $table->double('total_builtUpAreaValue_per_sqm', 8, 2)->nullable();
            $table->string('investment_in')->nullable();
            $table->double('totalNumber_of_investment_in', 8, 2)->nullable();
            $table->double('real_state_value', 8, 2)->nullable();
            $table->double('propost_additional_investment_cost', 8, 2)->nullable();
            ...
            $table->double('expectedProfit_%_ AfterBreakEven_AsPerStudy',8,2)->nullable();
            $table->double('real_estate_share_value_of_land_in_sqm',8,2)->nullable();
            $table->double('realEstate_shareValue_of_construction_in_sqm', 8, 2)->nullable();
            $table->double('realEstate_shareValue_in_number_of_investing_in',8,2)->nullable();
