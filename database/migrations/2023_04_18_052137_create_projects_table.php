...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('projects', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('area_starting_per_sqm', 20, 2)->nullable();
            $table->unsignedDecimal('price_starting_per_sqm', 20, 2)->nullable();
            $table->unsignedDecimal('land_price_starting', 20, 2)->nullable();
            $table->string('land_number')->nullable()->limit(255);
            $table->string('land_category')->nullable()->limit(255);
            $table->unsignedDecimal('land_area', 20, 2)->nullable();
            $table->unsignedDecimal('land_price_per_sqm', 20, 2)->nullable();
            $table->unsignedDecimal('total_land_price', 20, 2)->nullable();
            ...
            $table->unsignedDecimal('total_price_with_land', 20, 2)->nullable();
